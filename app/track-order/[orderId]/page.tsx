        ...
        return (
            <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-4">
                <div className="bg-[#0A0A0A] border border-red-500/20 rounded-xl p-8 max-w-md text-center">
                    ...
                    <Link href="/track-order" className="text-primary hover:text-white transition-colors uppercase text-[14px] font-bold tracking-widest">
        ...
        <div className="min-h-screen bg-[#050505] text-white py-20 px-4 md:px-10">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                    <div>
                        <Link href="/orders" className="flex items-center gap-2 text-slate-500 hover:text-white transition-colors text-[14px] font-bold uppercase tracking-widest mb-4">
                        ...
                        <p className="text-slate-500 text-[14px] mt-1 font-mono">ID: {order.id}</p>
                    </div>
                    <div className={`px-6 py-2 rounded-full border text-[14px] font-black uppercase tracking-widest ${getStatusColor(order.status)}`}>
                        {order.status}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        ...
                        <div className="bg-[#0A0A0A] border border-white/5 rounded-2xl overflow-hidden p-6">
                            <h2 className="text-[14px] font-bold text-slate-500 uppercase tracking-widest mb-6">Service Details</h2>
                            <div className="flex gap-6">
                                ...
                                <div>
                                    <div className="text-[14px] font-bold text-primary uppercase tracking-widest mb-1">{order.gameName}</div>
                        ...
                        <div className="bg-[#0A0A0A] border border-white/5 rounded-2xl p-6">
                            <h2 className="text-[14px] font-bold text-slate-500 uppercase tracking-widest mb-6">Progress Timeline</h2>
                            <div className="space-y-8 relative before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-0.5 before:bg-white/5">
                                <div className="relative flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-500 text-[14px] mt-1">{new Date(order.createdAt).toLocaleString()}</p>
                                    </div>
                                </div>
                                <div className="relative flex gap-4">
                    ...
                    <div className="space-y-6">
                        <div className="bg-[#0A0A0A] border border-white/5 rounded-2xl p-6">
                            <h2 className="text-[14px] font-bold text-slate-500 uppercase tracking-widest mb-4">Customer Info</h2>
                            <div className="space-y-4">
                                <div>
                                    <label className="text-[14px] font-bold text-slate-600 uppercase tracking-wider block mb-1">Email</label>
                                    <div className="text-sm font-medium text-white">{order.guestEmail || "N/A (Guest)"}</div>
                                </div>
                                <div>
                                    <label className="text-[14px] font-bold text-slate-600 uppercase tracking-wider block mb-1">Order Date</label>
                        ...
                        <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6">
                            <h2 className="text-[14px] font-bold text-primary uppercase tracking-widest mb-2">Need Help?</h2>
                            <p className="text-[14px] text-slate-400 mb-4 leading-relaxed">
                                If you have any questions about your order, please contact our support team with your Order ID.
                            </p>
                            <Link href="/contact" className="w-full bg-[#0A0A0A] hover:bg-[#111] text-white border border-white/10 rounded-lg py-3 flex items-center justify-center gap-2 text-[14px] font-bold uppercase tracking-widest transition-all">
                                Contact Support
                            </Link>
                        </div>
                    </div>
