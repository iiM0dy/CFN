...
export default function WallOfFamePage() {
    return (
        <div className="relative flex min-h-screen w-full flex-col bg-[#181112] text-white font-(family-name:--font-space-grotesk)">
            ...
            <main className="flex-1 flex flex-col items-center w-full px-6 py-8 md:py-12">
                <div className="w-full max-w-7xl flex flex-col gap-10">
                    ...
                    <section className="relative overflow-hidden rounded-2xl bg-[#251a1c] border border-[#38292b]">
                        <div className="absolute inset-0 z-0 bg-linear-to-r from-[#181112] via-[#181112]/90 to-transparent" />
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-8 md:p-12 gap-8">
                            <div className="flex flex-col gap-4 max-w-2xl">
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 w-fit">
                                    ...
                                    <span className="text-primary text-[14px] font-bold uppercase tracking-wider">Verified Reviews</span>
                                </div>
                            ...
                            <div className="flex flex-wrap gap-4 w-full md:w-auto justify-start md:justify-end">
                                <div className="flex flex-col gap-1 p-5 rounded-xl bg-[#181112]/80 backdrop-blur border border-[#38292b] min-w-[140px]">
                                    <span className="text-gray-400 text-[14px] font-medium">Average Rating</span>
                                    <div className="flex items-end gap-2">
                                        <span className="text-3xl font-bold text-white">4.9</span>
                                        <span className="text-[14px] text-gray-500 mb-1">/ 5.0</span>
                                    </div>
                                    <StarIcons count={5} />
                                </div>
                                <div className="flex flex-col gap-1 p-5 rounded-xl bg-[#181112]/80 backdrop-blur border border-[#38292b] min-w-[140px]">
                                    <span className="text-gray-400 text-[14px] font-medium">Orders Completed</span>
                                    <span className="text-3xl font-bold text-white">12k+</span>
                                    <span className="text-[14px] text-green-500 flex items-center gap-1">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
                        <div className="flex flex-wrap gap-3">
                            <button className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#251a1c] border border-[#38292b] hover:border-primary/50 text-white text-[14px] font-medium transition-colors">
                            ...
                            <button className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-primary/10 border border-primary/30 text-primary text-[14px] font-bold">
                        ...
                        <div className="flex w-full md:w-auto gap-3">
                            <div className="relative flex-1 md:w-64">
                                ...
                                <input className="w-full bg-[#251a1c] border border-[#38292b] rounded-lg py-2.5 pl-10 pr-4 text-white text-[14px] placeholder-gray-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" placeholder="Search reviews..." type="text" />
                            </div>
                        </div>
                    </div>
                            ...
                            <div key={i} className="flex flex-col p-6 rounded-xl bg-[#251a1c] border border-[#38292b] hover:border-primary/40 hover:shadow-[0_0_20px_rgba(0,0,0,0.4)] transition-all duration-300">
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex items-center gap-3">
                                        <div className={`size-10 rounded-full ${r.gradient ? `bg-linear-to-br ${r.gradient}` : 'bg-gray-800'} flex items-center justify-center text-white font-bold border border-[#38292b] text-[14px]`}>
                                            {r.initials || (
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-500 text-[14px] mt-1">{r.time}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="mb-4">
                                    <div className="inline-flex flex-wrap gap-2 mb-3">
                                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[14px] font-bold uppercase tracking-wider bg-primary/20 text-primary border border-primary/20">
                                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                            Verified
                                        </span>
                                        <span className="inline-flex items-center px-2 py-0.5 rounded text-[14px] font-bold uppercase tracking-wider bg-[#38292b] text-gray-300 border border-gray-700">{r.game}</span>
                                        <span className="inline-flex items-center px-2 py-0.5 rounded text-[14px] font-bold uppercase tracking-wider bg-[#38292b] text-gray-300 border border-gray-700">{r.service}</span>
                                    </div>
                                    <p className="text-gray-300 text-[14px] leading-relaxed">{r.text}</p>
                                </div>
                                <div className="mt-auto pt-4 border-t border-[#38292b] flex items-center justify-between">
                                    <span className="text-[14px] text-gray-500">Booster: <span className="text-white font-medium">{r.booster}</span></span>
            ...
            <footer className="bg-[#080808] border-t border-[#38292b] py-12 px-6">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex items-center gap-3 text-white">
                        <CFNLogo className="size-8" />
                        <span className="text-[14px] font-black tracking-widest uppercase font-cairo text-gray-400">© 2024 CFNBOOST. All rights reserved.</span>
                    </div>
