...
const faqData: Record<string, { q: string; a: string }[]> = {
    ...
    security: [
        { q: "Is my account safe during boosting?", a: 'Yes. All Airwick boosters are required to use VPNs matching your geographic location to mimic your login patterns. We also use "Appear Offline" mode by default to ensure privacy from your friends list.' },
        ...
        <div className="bg-[#211113] text-white min-h-screen flex flex-col font-[family-name:var(--font-space-grotesk)]">
            ...
            <footer className="border-t border-[#533c3f] bg-[#181112] py-12 px-6">
                <div className="container mx-auto flex flex-col md:flex-row justify-between items-start gap-8">
                    <div className="flex flex-col gap-4 max-w-sm">
                        <div className="flex items-center gap-2 text-white">
                            ...
                            <span className="text-xl font-bold">Airwick</span>
                        </div>
                ...
                <div className="container mx-auto mt-12 pt-8 border-t border-[#533c3f] flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[#b89da1]">
                    <p>© 2024 Airwick Inc. All rights reserved.</p>
