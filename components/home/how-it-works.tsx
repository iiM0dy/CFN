        ...
        <section className="py-24 bg-[#050505]">
            <div className="relative max-w-[1440px] mx-auto px-6 lg:px-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Step 01 */}
                    <div className="group p-8 rounded-2xl bg-white/2 border border-white/5 hover:border-primary/20 transition-all duration-300">
                        <div className="flex justify-between items-start mb-8">
                            ...
                            <span className="text-[14px] font-black text-slate-700 uppercase tracking-[0.2em]">P-01</span>
                        </div>
                    ...
                    <div className="group p-8 rounded-2xl bg-white/2 border border-white/5 hover:border-primary/20 transition-all duration-300">
                        <div className="flex justify-between items-start mb-8">
                            ...
                            <span className="text-[14px] font-black text-slate-700 uppercase tracking-[0.2em]">P-02</span>
                        </div>
                    ...
                    <div className="group p-8 rounded-2xl bg-white/2 border border-white/5 hover:border-primary/20 transition-all duration-300">
                        <div className="flex justify-between items-start mb-8">
                            ...
                            <span className="text-[14px] font-black text-slate-700 uppercase tracking-[0.2em]">P-03</span>
                        </div>
                ...
                <div className="mt-20 pt-10 border-t border-white/5">
                    <div className="flex flex-wrap justify-between gap-8 opacity-40 hover:opacity-100 transition-opacity duration-500">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[14px] font-black text-white uppercase tracking-widest">SSL SECURED</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="material-symbols-outlined text-emerald-500 text-[18px]">vpn_lock</span>
                            <span className="text-[14px] font-black text-white uppercase tracking-widest">VPN PROTECTED</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="material-symbols-outlined text-emerald-500 text-[18px]">shield_person</span>
                            <span className="text-[14px] font-black text-white uppercase tracking-widest">ENCRYPTED DATA</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="material-symbols-outlined text-emerald-500 text-[18px]">support_agent</span>
                            <span className="text-[14px] font-black text-white uppercase tracking-widest">24/7 LIVE OPS</span>
                        </div>
                    </div>
                </div>
            </div>
