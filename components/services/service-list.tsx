...
export function ServiceList({ initialServices }: ServiceListProps) {
    ...
    return (
        <div className="font-cairo">
            {/* Search Bar & Header */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-8.25 px-2">
                        ...
                        <div className="absolute inset-0 z-0">
                            {service.image ? (
                                <img
                                    src={service.image}
                                    alt={service.name}
                                    className="w-full h-full object-cover object-[center_20%] group-hover:scale-105 transition-all duration-1000 opacity-70 group-hover:opacity-100"
                                />
                            ) : (
